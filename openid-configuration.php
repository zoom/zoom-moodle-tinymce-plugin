...
$conf = [
    ...
    'authorization_endpoint' => (new moodle_url('/lib/editor/tiny/plugins/zoomclassroom/auth.php'))->out(false),
    'registration_endpoint' => (new moodle_url('/lib/editor/tiny/plugins/zoomclassroom/openid-registration.php'))->out(false),
