...
copy_path "placeholder.php"
copy_path "locallib.php"
copy_path "view.php"
copy_path "auth.php"
copy_path "contentitem_return.php"
copy_path "register.php"
copy_path "startregistration.php"
copy_path "openid-configuration.php"
copy_path "openid-registration.php"
copy_path "LICENSE"
copy_path "README.md"
copy_path "db"
copy_path "classes"
